...
***************/
	...
	A->Triangle(-0.6f, -0.3f, 0.6f, -0.3f, 0.6f, 0.3f,0.5f, 0.5f, 0.0f); //Base
	A->Triangle(-0.6f, -0.3f,-0.6f, 0.3f,0.6f, 0.3f,0.5f, 0.5f, 0.0f); //Base
  A->Triangle(-0.6f, -0.3f,0.6f, -0.3f,0.0f,-0.9f,0.0f,0.0f,1.0f); // roof
  A->Triangle(-1.0f,0.3f,-1.0f,1.0f,1.0f,1.0f,0.545f,0.270f,0.0745f); //field
  A->Triangle(-1.0f,0.3f,1.0f,0.3f,1.0f,1.0f,0.545f,0.270f,0.0745f); //field
  A->Line(-0.4f,0.3f,-0.4f,0.0f,1.0f,0.0f,0.0f); //door
  A->Line(-0.3f,0.3f,-0.3f,0.0f,1.0f,0.0f,0.0f); // door
  A->Line(-0.4f,0.0f,-0.3f,0.0f,1.0f,0.0f,0.0f); // door
}
