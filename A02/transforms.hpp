...
***************/
	...
	M = glm::scale(glm::mat4(1.0f),glm::vec3(2.0f,1.0f,1.25f)) *
      glm::translate(glm::mat4(1.0f),glm::vec3(0.0f,0.0f,-1.0f));
	A->SetMatrix(6,  M, false);

	M = glm::shearZ3D(glm::mat4(1.0f),-0.5f,0.0f) *
      glm::translate(glm::mat4(1.0f),glm::vec3(2.0f,0.0f,-1.0f));
  ...
  glm::mat4 Sxy(1.0f);
	...
	M = glm::scale(glm::mat4(1.0f),glm::vec3(2.0f,2.0f,2.0f)) *
			...
			glm::translate(glm::mat4(1.0f),glm::vec3(-1.0f,1.0f,1.5f));
	A->SetMatrix(10, M, false);

	M =	glm::rotate(glm::mat4(1.0f),glm::radians(135.0f),glm::vec3(0.0f,1.0f,0.0f)) *
			glm::translate(glm::mat4(1.0f),glm::vec3(-2.70711f,2.0f,-0.87868f));
	A->SetMatrix(11, M, false);

	M = glm::scale(glm::mat4(1.0f),glm::vec3(1.0f,1.0f,0.5f))*
			glm::rotate(glm::mat4(1.0f),glm::radians(90.0f),glm::vec3(0.0f,1.0f,0.0f))*
			glm::translate(glm::mat4(1.0f),glm::vec3(1.0f,2.0f,0.0f));
	A->SetMatrix(12, M, false);

	M =	glm::rotate(glm::mat4(1.0f),-2.0943951024f,glm::vec3(0.81649658f,-0.57735027f,0.0f))*
			glm::translate(glm::mat4(1.0f),glm::vec3(-0.914213f,-0.707107f,0.914213f));
	A->SetMatrix(13, M, false);

	M = glm::rotate(glm::mat4(1.0f),glm::radians(150.0f),glm::vec3(0.0f,1.0f,0.0f))*
			glm::translate(glm::mat4(1.0f),glm::vec3(2.23205f,2.0f,0.133975f));
